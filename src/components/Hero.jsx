  ...
  return (
    <section id="home" className="flex flex-col md:flex-row justify-between items-center px-4 sm:px-6 lg:px-8 pt-44 pb-16 container mx-auto">
      ...
      <div className="w-full md:w-1/2 space-y-8">
        ...
        >
          Whether you’re purchasing a home, refinancing your existing property, or getting a reverse mortgage, ARAMCO redefines the life-cycle of today’s homeowner.
        </motion.p>
